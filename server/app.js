/**
 * ============================================================
 * Qismat Server — Express অ্যাপ (cPanel / live startup file)
 * ============================================================
 * এই ফাইলে:
 *   - সব /api/* রাউট মাউন্ট
 *   - CORS, helmet, rate limit
 *   - স্ট্যাটিক /uploads
 *   - landing DB কলাম চেক (ensureLandingColumns)
 *
 * চালানো: node app.js  |  npm start
...
/** সরাসরি চালালে (node app.js / cPanel startup) — সার্ভার শোনা শুরু */
